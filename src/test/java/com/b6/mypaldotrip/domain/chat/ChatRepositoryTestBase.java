...
public abstract class ChatRepositoryTestBase extends CommonControllerTest {
    ...
    @MockBean protected ChatRoomEntityRepository chatRoomEntityRepository;

    @MockBean protected ChatMessageRepository chatMessageRepository;
    ...
    void setup() {
        ...
        chatRoom1 = ChatRoomEntity.builder().chatRoomId(chatRoomId1).chatRoomName("마산").build();

        chatRoom2 = ChatRoomEntity.builder().chatRoomId(chatRoomId2).chatRoomName("군산").build();
        ...
        // Mocking 설정
        when(chatRoomEntityRepository.findByChatRoomName(chatRoom1.getChatRoomName()))
                .thenReturn(Optional.of(chatRoom1));
        when(chatRoomEntityRepository.findByChatRoomName(chatRoom2.getChatRoomName()))
        ...
        chatRoomIdRes = ChatRoomIdRes.builder().chatRoomId(chatRoom2.getChatRoomId()).build();
    }
}
